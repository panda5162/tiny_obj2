...
if __name__ == '__main__':
    print('train:', count_split_examples('/media/panda/DATA1/ssd/dataset/tfrecords', 'train-?????-of-?????'))
    print('val:', count_split_examples('/media/panda/DATA1/ssd/dataset/tfrecords', 'val-?????-of-?????'))
